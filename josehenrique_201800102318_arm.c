...
#include <stdint.h>
// DefiniÃ§Ã£o dos registradores de GPIO A/C
...
// DefiniÃ§Ã£o de campos de GPIO A/C
#define	PA0_CNF				(2)
#define	PA0_MODE			(0)
#define	PA9_CNF				(6)
#define	PA9_MODE			(4)
...
#define	PC13_ODR			(13)
#define PC12_0DR            (12)
// DefiniÃ§Ã£o do registrador de RCC
#define	RCC_APB2ENR			(0x40021018)
// DefiniÃ§Ã£o de campos de RCC
#define	RCC_AFIO_EN  		(0)
#define	RCC_GPIOA_EN  		(2)
#define	RCC_GPIOC_EN  		(4)
#define	RCC_USART1_EN  		(14)
// DefiniÃ§Ã£o de registradores de SysTick
#define SYST_CSR  			(0xE000E010)
#define SYST_RVR  			(0xE000E014)
// DefiniÃ§Ã£o de campos de SYST_CSR
#define	SYST_CSR_CLKSOURCE	(2)
#define	SYST_CSR_TICKINT	(1)
#define	SYST_CSR_ENABLE		(0)
// DefiniÃ§Ã£o de registradores de AFIO, EXTI e NVIC
...
// DefiniÃ§Ã£o de registradores de USART1
...
// DefiniÃ§aÃ£o de campos da USART1
#define	USART1_RXNE			(5)
#define	USART1_TXE			(7)
#define	USART1_UE			(13)
#define	USART1_TE			(3)
#define	USART1_RE			(2)
// DeclaraÃ§Ã£o de topo da pilha e de funÃ§Ãµes
extern char _estack;
int main();
void SysTick();
void botao();
// Tabela de vetor de interrupÃ§Ã£o
...
// DeclaraÃ§Ã£o de funÃ§Ã£o print_serial
...
void botao() {
	...
	// Checando se valor de recarga Ã© 8000000
	if((*RVR) == 8000000) {
		// Ajustando para 800000
		(*RVR) = 800000;
	}
	// Valor de recarga Ã© 800000
	else {
	...
	// Habilitando SysTick
	(*CSR) |= (1 << SYST_CSR_ENABLE);
	// Checando registrador de pendÃªncia
	if((*PR) & 1) {
		// Limpando pendÃªncia no bit 0
		(*PR) = 1;
	}
}
// Configurar pinos
void configurar_pinos() {
	...
	(*PA_CRL) |= (0b10 << PA0_CNF);
	// Ajustando PA9 (TX) e PA10 (RX) como funÃ§Ã£o alternativa
...
// Configurar pino PA0 para interrupÃ§Ã£o em EXTI0
void configurar_PA0_EXTI0() {
	// EXTI0 <-> GPIO A
	(*EXTICR1) &= 0xFFF0;
	// InterrupÃ§Ã£o por gatilho de borda negativa
	(*FTSR) |= 1;
	// Desativar mascaramento
	(*IMR) |= 1;
	// Habilitando interrupÃ§Ã£o
	(*ISER0) |= (1 << 6);
	// Ajustando prioridade para nÃ­vel 13
	IPR[6] = 0xD0;
}
// Configurar USART1
void configurar_USART1() {
	...
	(*U1BRR) = 0x341;
	// Habilitando recepÃ§Ã£o e transmissÃ£o
...
int main() {
	// Caracteres de texto
	char texto[100];
	// ConfiguraÃ§Ã£o de pinos, SysTick, interrupÃ§Ã£o
	configurar_pinos();
	configurar_SysTick();
